...
public class OperatorCardinality {
    ...
    private static boolean updateJoinCardinality(Join j, Map<String, Integer> tableAliasToId,
        ...
        boolean child1HasJoinPK = pureFieldName1.equals(Database.getCatalog().getPrimaryKey(
                tableAliasToId.get(tableAlias1)));
        boolean child2HasJoinPK = pureFieldName2.equals(Database.getCatalog().getPrimaryKey(
                tableAliasToId.get(tableAlias2)));
